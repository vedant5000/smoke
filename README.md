...
| --- | --- | --- |
| `BUNNY_LIBRARY_ID` | yes | The number, e.g. `717099` |
...
The library used here is **Smoke** (`717099`), created for this app so nothing mixes with your
other Bunny content. Its player is themed to the Cue accent and referrer blocking is off, so links work
when pasted into email, GHL, or anywhere else.
